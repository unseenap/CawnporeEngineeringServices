...
export default function AboutPage(){return <main className="corp-site">
  <CorporateHero label="About us" title="Engineering built around accountability." description="A Kanpur-based HVAC partner serving projects and operating facilities across India." image="/images/services/consultancy/hvac-design-consultation.png" />
  <section className="section"><div className="site-container corp-about-story"><Reveal className="corp-about-image"><Image src="/images/services/consultancy/hvac-design-consultation.png" alt="HVAC system design consultation" fill unoptimized sizes="(max-width:800px) 100vw, 48vw" /></Reveal><Reveal delay={.1}><span className="corp-kicker">Who we are</span><h2>Practical HVAC expertise from design through service.</h2><p>Cawnpore Engineering Services was founded in 2021 to bring technical clarity, coordinated execution and responsive lifecycle support into one dependable relationship.</p><p>We work across commercial, industrial, healthcare, hospitality, retail and residential environments, adapting every system to its actual load, use and operating priorities.</p><ul className="corp-checks">{company.strengths.slice(0,6).map(item=><li key={item}><CheckCircle />{item}</li>)}</ul></Reveal></div></section>

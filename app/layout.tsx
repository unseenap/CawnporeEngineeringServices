...
export const metadata: Metadata = {
  ...
  description:
    "Professional HVAC solutions for commercial, residential and industrial environments across India.",
  ...
  openGraph: {
    ...
    description:
      "HVAC design, installation and lifecycle service for commercial, residential and industrial environments across India.",
    type: "website",
    siteName: SITE_NAME,
    locale: "en_IN",
    images: [
  ...
  twitter: {
    ...
    description:
      "HVAC design, installation and lifecycle service for commercial, residential and industrial environments across India.",
    images: [
      "/images/services/basement-ventilation/parking-ventilation-hero.jpeg",
    ],
  },
};
